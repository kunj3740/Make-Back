...
const fetchComponentsByProject = async () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-md shadow-2xl border border-gray-700/50 overflow-hidden backdrop-blur-sm flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700/50 bg-gradient-to-r from-gray-800 via-gray-750 to-gray-800">
        <div className="flex items-center gap-3">
          <span className="ml-4 font-semibold text-lg text-gray-300">
        ...
        <div className="w-64 border-r border-gray-700/50 bg-gradient-to-b from-gray-800/80 to-gray-900/80 p-4 flex flex-col">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded-full bg-blue-600 text-white hover:bg-blue-700 hover:scale-110 transition-all"
            >
              +
            </button>
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                disabled={isCreating}
                className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-700/50 text-gray-400 hover:bg-gray-600/50 hover:text-gray-200 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                ×
              </button>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setCreatePageData(prev => ({ ...prev, name: e.target.value }))}
                  disabled={isCreating}
                  className="w-full px-4 py-3 rounded-lg bg-gray-800/50 border border-gray-600 text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  placeholder="Enter page name"
                  onKeyPress={(e) => e.key === 'Enter' && !isCreating && createPageData.name.trim() && createPageData.description.trim() && handleCreatePage()}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setCreatePageData(prev => ({ ...prev, description: e.target.value }))}
                  disabled={isCreating}
                  className="w-full px-4 py-3 rounded-lg bg-gray-800/50 border border-gray-600 text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none disabled:opacity-50 disabled:cursor-not-allowed"
                  placeholder="Enter page description"
                  rows="3"
                />
              </div>
            ...
            <div className="flex gap-3 mt-6">
              <button
                ...
                disabled={isCreating}
                className="flex-1 px-4 py-3 rounded-lg bg-gray-700/50 text-gray-300 hover:bg-gray-600/50 hover:text-white transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
                onClick={handleCreatePage}
                disabled={!createPageData.name.trim() || !createPageData.description.trim() || isCreating}
                className="flex-1 px-4 py-3 rounded-lg bg-blue-600 text-white hover:bg-blue-700 disabled:bg-gray-600 disabled:text-gray-400 disabled:cursor-not-allowed transition-all font-medium flex items-center justify-center gap-2"
              >
                {isCreating ? (
                  <>
