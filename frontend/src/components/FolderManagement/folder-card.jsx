            ...
            {isEditing ? (
              <div className="flex-1">
                <input
                  ...
                  className="font-bold bg-slate-800/50 text-white border border-slate-600/50 rounded-lg px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-cyan-500/50 text-sm"
                  onClick={(e) => e.stopPropagation()}
                />
