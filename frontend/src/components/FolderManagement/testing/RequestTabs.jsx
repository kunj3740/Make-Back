      ...
      <div className="p-8 bg-gradient-to-br from-slate-900/50 to-slate-800/50 min-h-[350px]">
        {activeTab === "params" && (
          <ParametersTab
            ...
            onUpdateParam={onUpdateParam}
            onRemoveParam={onRemoveParam}
            onAddPathParam={onAddPathParam}
            onUpdatePathParam={onUpdatePathParam}
            onRemovePathParam={onRemovePathParam}
          />
        )}

        {activeTab === "auth" && <AuthTab auth={testRequest.auth} onAuthChange={onAuthChange} />}
        ...
        {activeTab === "body" && (
          <BodyTab body={testRequest.body} method={testRequest.method} onBodyChange={onBodyChange} />
        )}
      </div>
    </>
  )
